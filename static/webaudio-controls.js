...
try{
    ...
    constructor(){
      super();
      this.addEventListener('dblclick', ()=>this.setValue(this.defvalue, true))
      this.addEventListener("contextmenu", ()=>this.setValue(this.defvalue, true))
...
<defs>
  ...
  <line id="K" x1="32" y1="25" x2="32" y2="11" stroke-linecap="round" stroke-width="6" stroke="${this.coltab[0]}"/>
     ...
     *
     * If the element is enabled, this function is called when a pointer is pressed
     * down on the element. If the element is disabled, the function just returns.
     *
     * The function will then attach a handler to the document's pointermove event,
     */
    ...
    pointerdown(ev){
      ...
      if(ev.timeStamp - this.timing < 200){
        this.timing = ev.timeStamp;
